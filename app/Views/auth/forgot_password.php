...
<body class="bg-emerald-50 min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
    ...
    <div
        class="absolute top-10 left-10 w-72 h-72 bg-emerald-200 rounded-full mix-blend-multiply filter blur-3xl opacity-60 animate-blob">
    </div>
    <div
        class="absolute bottom-10 right-10 w-96 h-96 bg-teal-200 rounded-full mix-blend-multiply filter blur-3xl opacity-50 animate-blob animation-delay-2000">
    </div>

    <div class="w-full max-w-md z-10">
        <div
            class="bg-white/90 backdrop-blur-lg rounded-3xl shadow-2xl shadow-emerald-950/10 border border-white/20 p-6 md:p-8">

            <div class="text-center mb-6">
                <div
                    class="mx-auto w-16 h-16 bg-gradient-to-tr from-emerald-500 to-teal-400 rounded-2xl flex items-center justify-center shadow-lg shadow-emerald-500/30 mb-4 transform hover:rotate-6 transition-transform duration-300">
            ...
            <form action="/forgot-password/process" method="post" class="space-y-4">
                ...
                <div class="space-y-1.5">
                    <label class="text-xs font-bold text-slate-800 block ml-1 mt">Username</label>
                ...
                <div class="space-y-1.5">
                    <label class="text-xs font-bold text-slate-800 block ml-1 mt-4">Password Baru</label>
                    <div class="relative group">
                        <div
                            class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400 group-focus-within:text-emerald-500 transition-colors">
                ...
                <div class="space-y-1.5">
                    <label class="text-xs font-bold text-slate-800 block ml-1 mt-4">Konfirmasi Password</label>
                    <div class="relative group">
                        <div
                            class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400 group-focus-within:text-emerald-500 transition-colors">
                ...
                <button type="submit"
                    class="w-full py-3.5 mt-8 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-xl shadow-lg shadow-emerald-600/20 hover:shadow-emerald-600/30 transform hover:-translate-y-0.5 transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-emerald-500/50 text-sm">
                    Reset Password
                </button>
