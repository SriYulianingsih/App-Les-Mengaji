...
<div class="container mx-auto p-6 max-w-4xl">
    <div class="mb-8 text-left">
        ...
        <p class="text-sm text-slate-500 mt-1">Ubah rincian kategori pembayaran.</p>
    </div>

    <div class="bg-white rounded-[2rem] shadow-sm border border-slate-100 overflow-hidden text-left">
        <div class="h-1.5 w-full bg-indigo-500"></div>
        <form action="/admin/kategori-pembayaran/update/<?= $kategori['id'] ?>" method="POST" class="p-8 space-y-6">
            <?= csrf_field() ?>
