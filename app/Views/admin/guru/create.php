...
<div class="container mx-auto p-6 max-w-5xl">
    ...
    <form action="/admin/guru/store" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="md:col-span-2 bg-white p-6 rounded-xl shadow-sm border border-gray-100 space-y-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="no_hp" value="<?= old('no_hp') ?>" placeholder="Misal: 081234567890"
                            class="mt-1.5 w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all text-sm">
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <textarea name="alamat" rows="3"
                        class="mt-1.5 w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all text-sm"><?= old('alamat') ?></textarea>
                </div>
            </div>
            ...
            <div class="space-y-6">
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 space-y-4 self-start">
                    ...
                    <div>
                        <div id="wrapper-preview" class="hidden mb-3">
                            <div class="relative w-full h-40">
                                ...
                                <button type="button" onclick="resetGambar()"
                                    class="absolute top-2 right-2 bg-white/90 p-1.5 rounded-full text-rose-600 hover:bg-white hover:text-rose-700 shadow-sm transition-colors">
                        ...
                        <div id="kotak-upload"
                            class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-200 border-dashed rounded-lg hover:border-indigo-300 transition-all cursor-pointer">
        ...
        <div class="flex justify-end mt-4">
            <button type="submit"
                class="bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-700 hover:to-indigo-800 text-white font-semibold px-6 py-2.5 rounded-lg text-sm shadow-md shadow-indigo-100 transition-all duration-200 transform hover:-translate-y-0.5">
                Simpan Data Guru
            </button>
        </div>
    </form>
