...
<div class="container mx-auto p-6 max-w-7xl">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8 gap-4">
        <div>
            ...
            <p class="text-sm text-slate-500 mt-1">Kelola pembagian kelas dan pantau populasi santri di setiap jenjang.
            </p>
        </div>
    ...
    <div class="bg-white rounded-3xl border border-slate-150 p-16 text-center shadow-sm">
        <div
            class="w-20 h-20 bg-slate-50 text-slate-300 rounded-3xl flex items-center justify-center mx-auto mb-4 text-3xl">
        ...
        <a href="/admin/kelas/create" class="text-indigo-600 font-bold text-sm hover:underline">Mulai Tambah Kelas <i
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        <div
            class="bg-white rounded-3xl border border-slate-100 shadow-sm hover:shadow-xl hover:border-indigo-100 transition-all duration-300 overflow-hidden flex flex-col justify-between group">

            <div class="p-6">
                <div class="flex items-center justify-between mb-5">
                    <span
                        class="inline-flex items-center px-3 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-wider bg-indigo-50 text-indigo-700 border border-indigo-100">
                ...
                <div class="mb-6">
                    ...
                    <h3
                        class="text-xl font-black text-slate-800 group-hover:text-indigo-600 transition-colors tracking-tight">
                        <?= esc($k['nama_kelas']) ?>
                    </h3>
                </div>

                <div
                    class="flex items-center gap-3 p-3 bg-slate-50 rounded-2xl group-hover:bg-indigo-50 transition-colors">
                    <div
                        class="w-10 h-10 bg-white text-slate-400 rounded-xl flex items-center justify-center text-sm shadow-sm group-hover:text-indigo-500 transition-colors">
                        <i class="fas fa-users"></i>
                    </div>
                    <div>
                        <p class="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Total Santri</p>
                        <p
                            class="text-sm font-black <?= $k['total_santri'] > 0 ? 'text-indigo-600' : 'text-slate-400 italic' ?>">
                            <?= $k['total_santri'] ?> <span
                                class="text-[10px] font-medium text-slate-400 uppercase ml-0.5">Orang</span>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div
                class="bg-slate-50/50 px-6 py-4 border-t border-slate-100 flex items-center justify-between group-hover:bg-indigo-50/30 transition-all">
