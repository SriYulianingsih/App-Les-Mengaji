            ...
            <div class="space-y-6">
                <div>
                    ...
                    <div class="relative group text-left">
                        ...
                        <input type="text" name="nama_mapel" value="<?= esc($mapel['nama_mapel']) ?>" required
                ...
                <div>
                    ...
                    <div class="relative group text-left">
                        ...
                        <textarea name="keterangan" rows="3"
                                  class="w-full pl-11 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:bg-white transition-all font-medium text-slate-700"><?= esc($mapel['keterangan']) ?></textarea>
                    </div>
                </div>
            </div>
