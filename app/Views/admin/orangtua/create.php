...
<div class="container mx-auto p-6 max-w-5xl">
    <div class="mb-8">
        <a href="/admin/orangtua"
            class="text-sm text-emerald-600 hover:text-emerald-700 font-medium flex items-center mb-2 gap-1 transition-all">
        ...
        <p class="text-sm text-gray-500 mt-1">Silakan lengkapi formulir di bawah untuk mendaftarkan wali santri baru.
        </p>
    </div>

    <?php if (session()->getFlashdata('errors')) : ?>
    <div
        class="bg-rose-50 border-l-4 border-rose-500 text-rose-800 px-4 py-3.5 rounded-lg mb-6 shadow-sm flex items-start gap-3">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-6">
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Nama Ayah <span
                                class="text-rose-500">*</span></label>
                        <input type="text" name="nama_ayah" value="<?= old('nama_ayah') ?>"
                            placeholder="Nama lengkap ayah"
                            class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all text-sm"
                            required>
                    </div>
                    ...
                    <div class="pt-2">
                        <label class="block text-sm font-medium text-gray-700 mb-1">Nama Ibu <span
                                class="text-rose-500">*</span></label>
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">No. Handphone / WA <span
                                class="text-rose-500">*</span></label>
                    ...
                    <div>
                        ...
                        <input type="email" name="email" value="<?= old('email') ?>" placeholder="orangtua@email.com"
                            class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all text-sm">
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 space-y-4 h-fit">
                ...
                <div>
                    ...
                    <select id="provinsi" name="provinsi"
                        class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all text-sm bg-gray-50 cursor-pointer">
                ...
                <div>
                    ...
                    <select id="kabupaten" name="kabupaten"
                        class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all text-sm bg-gray-50 cursor-not-allowed"
                        disabled>
                ...
                <div class="grid grid-cols-3 gap-3">
                    ...
                    <div>
                        ...
                        <input type="text" name="kode_pos" value="<?= old('kode_pos') ?>" placeholder="xxxxx"
                            class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all text-sm">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="alamat" rows="2" placeholder="Tulis nama jalan, nomor rumah, atau patokan..."
                        class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all text-sm"><?= old('alamat') ?></textarea>
                </div>
            </div>
        </div>
