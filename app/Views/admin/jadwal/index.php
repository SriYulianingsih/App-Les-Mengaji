...
<div class="container mx-auto p-6 max-w-7xl">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8 gap-4">
        <div>
            <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight">Kelola Jadwal Pelajaran</h1>
            <p class="text-sm text-slate-500 mt-1">Atur dan pantau jam mengajar guru, mata pelajaran, serta pembagian
                kelas.</p>
        </div>
    ...
    <div class="bg-white rounded-2xl border border-slate-150 p-12 text-center">
        <div
            class="w-16 h-16 bg-slate-100 text-slate-400 rounded-2xl flex items-center justify-center mx-auto mb-4 text-2xl">
            <i class="fas fa-calendar-alt"></i>
        </div>
        <h3 class="text-lg font-bold text-slate-800">Belum Ada Jadwal</h3>
        <p class="text-sm text-slate-500 mt-1 mb-6">Klik tombol di kanan atas untuk menambahkan jadwal pelajaran
            pertama.</p>
    </div>
    <?php else : ?>
    <?php
        ...
        <div
            ...
            <div class="p-6">
                <div class="flex items-center justify-between mb-5">
                    <span
                        class="inline-flex items-center px-3 py-1.5 rounded-xl text-[11px] font-black uppercase tracking-wider bg-slate-100 text-slate-600">
                        <i class="far fa-calendar-alt mr-1.5"></i><?= esc($j['hari']) ?>
                    </span>
                    <span
                        class="inline-flex items-center px-3 py-1.5 rounded-xl text-[11px] font-black uppercase tracking-wider bg-indigo-50 text-indigo-700 border border-indigo-100">
                ...
                <div class="space-y-4">
                    <div class="flex items-center gap-3">
                        <div
                            class="w-10 h-10 bg-amber-50 text-amber-600 rounded-xl flex items-center justify-center text-sm shadow-sm">
                    ...
                    <div class="flex items-center gap-3">
                        <div
                            class="w-10 h-10 bg-indigo-50 text-indigo-600 rounded-xl flex items-center justify-center font-bold text-sm shadow-sm">
