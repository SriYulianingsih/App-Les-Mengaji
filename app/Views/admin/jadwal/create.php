...
<div class="container mx-auto p-6 max-w-4xl">
    ...
    <div class="mb-8">
        ...
        <p class="text-sm text-slate-500 mt-1">Hubungkan Guru, Mata Pelajaran, dan Kelas ke dalam satu jadwal mengajar.
        </p>
    </div>
    ...
    <div class="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
        <form action="/admin/jadwal/store" method="POST" class="p-6 md:p-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label for="guru_id"
                        class="block text-[11px] font-black uppercase tracking-widest text-slate-500 mb-2">Guru Pengampu
                ...
                <div>
                    <label for="mapel_id"
                        class="block text-[11px] font-black uppercase tracking-widest text-slate-500 mb-2">Mata
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label for="hari"
                        class="block text-[11px] font-black uppercase tracking-widest text-slate-500 mb-2">Hari <span
                            class="text-rose-500">*</span></label>
                    <div class="relative">
                        <i
                            class="far fa-calendar-alt absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 text-sm"></i>
                ...
                <div>
                    <label for="kelas_id"
                        class="block text-[11px] font-black uppercase tracking-widest text-slate-500 mb-2">Ruang / Kelas
                        <span class="text-rose-500">*</span></label>
                    <div class="relative">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pb-4">
                <div>
                    <label for="jam_mulai"
                        class="block text-[11px] font-black uppercase tracking-widest text-slate-500 mb-2">Jam Mulai
                        <span class="text-rose-500">*</span></label>
                    <div class="relative">
                ...
                <div>
                    <label for="jam_selesai"
                        class="block text-[11px] font-black uppercase tracking-widest text-slate-500 mb-2">Jam Selesai
                        <span class="text-rose-500">*</span></label>
                    <div class="relative">
                        <i class="far fa-clock absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 text-sm"></i>
