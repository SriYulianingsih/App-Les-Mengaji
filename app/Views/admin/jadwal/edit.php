...
<div class="container mx-auto p-6 max-w-4xl">
    ...
    <div class="mb-8">
        <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight">Edit Jadwal Pelajaran</h1>
        <p class="text-sm text-slate-500 mt-1">Lakukan penyesuaian jam mengajar atau pembagian kelas untuk jadwal ID: #<?= $jadwal['id'] ?></p>
    </div>

    <div class="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
        <form action="/admin/jadwal/update/<?= $jadwal['id'] ?>" method="POST" class="p-6 md:p-8 space-y-6">
            <?= csrf_field() ?>
