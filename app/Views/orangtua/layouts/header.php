...
document.addEventListener('DOMContentLoaded', function() {
    // Pop-up Info Jadwal (Halus & Sopan)
    <?php if (session()->getFlashdata('error_popup')) : ?>
        Swal.fire({
            ...
            confirmButtonText: 'SYUKRON, SAYA MENGERTI',
            background: '#ffffff',
            customClass: {
    ...
    <?php if (session()->getFlashdata('success')) : ?>
        Swal.fire({
            ...
            customClass: {
                ...
                title: 'text-xl font-black text-emerald-600 tracking-tight mt-2'
            }
        });
    <?php endif; ?>
    ...
    <?php if (session()->getFlashdata('error')) : ?>
        Swal.fire({
            icon: 'error',
            title: 'AFWAN, ADA KENDALA',
            text: '<?= session()->getFlashdata('error') ?>',
            confirmButtonColor: '#e11d48',
            confirmButtonText: 'KEMBALI',
            customClass: {
                popup: 'rounded-[2.5rem]',
                title: 'text-xl font-black text-rose-600 tracking-tight mt-2'
            }
        });
    <?php endif; ?>
});
